...
pdf_options:
  footerTemplate: |-
    <section>
      <div>
        スタッフ用 <span class="pageNumber"></span>
      </div>
    </section>
---
# プログラミング教室<br>スタッフ向けプリント👨‍🏫
...
### 第3 回 10/14（土）<br>ジャンプゲーム

- XY 座標・クローン・変数の復習
- □色に触れたブロックを使う

### 第4 回 11/11（土）<br>シューティングゲーム

- XY 座標・クローン・変数の復習

### 第5 回 11/25（土）<br>自分のゲームを作ろう
