...
<img src="./images/image31.png" alt="" width="300" />
...
<img src="./images/image3.png" alt="" width="150" />
...
<img src="./images/image5.png" alt="" width="600" />
...
<img src="./images/image7.png" alt="" width="200" />
<img src="./images/image8.png" alt="" width="300" />
</div>
...
#### ネコは使わないので削除する。
#### ボウル <img src="./images/image33.png" alt="" width="50" /> をプログラムして、横にだけ動くようにする。

<img src="./images/image34.png" alt="" width="600" />
...
<span class="simulate">頭の中で動かしてみる</span>
プログラムを一度頭の中で動かしてみて、どんな風に動くのかシミュレーションしよう。

![](./images/2022-09-26-04-46-32.png)
...
<div class="columns-two">
<img src="./images/image26.png" alt="" width="300" />
<img src="./images/image27.png" alt="" width="200" />
</div>
...
<div class="columns-two">
<img src="./images/image28.png" alt="" width="300" />
<img src="./images/image29.png" alt="" width="300" />
</div>
...
####  をクリックして、15 秒たったらゲームが終わることをたしかめる。
...
スコアを「へらす」ためには、どこを変えればいいだろう？
増やしているのは、どの命令かな？

## 自由に作品を作ろう

- 新しくゲームを作っても、これまでに作ったゲームを改良しても構いません。
- 改良するときのヒント
...
## 他の人に自分の作品を見せよう
- 一人ずつ、自分の作品を紹介しましょう。どんなふうに遊ぶのか、どんなところを工夫したか、なにがまだできていないのかなどを説明してください。
- 作品を紹介する人は順番に交代します。
